...
EOT;
	...
	public static function page($key)
	{
		...
		$segments->content = isset($segments->content) ? $segments->content : '<h2>Click here to create content</h2> <p>Before editing this page, rename it to anything you like in Settings -> General.</p>';
